...
Buffer::Buffer(size_t max_bytes)
    : _buf(), _off(0), _max_bytes(max_bytes), _overflow(false) {}

Buffer::~Buffer() {}

Buffer::Buffer(const Buffer &other)
    : _buf(other._buf), _off(other._off), _max_bytes(other._max_bytes),
...
size_t Buffer::max() const { return _max_bytes; }

bool Buffer::overflow() const { return _overflow; }

void Buffer::resetOverflow() { _overflow = false; }
